classdef rammus < champion
    ...
    methods
        ...
        function perform_action(obj,game,player,pick)
            ...
            obj.taunt_delay = max(0,obj.taunt_delay -1);
            obj.powerball_delay = max(0,obj.powerball_delay -1);
            obj.reflect_delay = max(0,obj.reflect_delay -1);
                ...
                switch pick{i}
                    ...
                    case 'e'
                        if obj.taunt_delay == 0
                            ...
                            game.hitmap(target_team).duration((-4:4)+r,(-4:4)+c) = 20; %length of taunt
